import"../chunks/DsnmJJEf.js";import{al as g,Z as p,$ as _,_ as d,X as Y,G as o,an as R,W as z,ac as O,Y as G,a9 as ee,J as H,aE as fe,am as P,ba as ge,I as ye}from"../chunks/C5V18K91.js";import{b as l,f as y,c as A,t as ve}from"../chunks/DAo7DBt3.js";import{b as C,g as be,f as se}from"../chunks/DJ561LLY.js";import{e as D,i as B,b as we,s as re,c as xe,d as ke}from"../chunks/CE9KbBQ4.js";import{e as K}from"../chunks/CowkXnMh.js";import{c as Q}from"../chunks/g_MYWaHd.js";import{s as $,p as I}from"../chunks/BhdR-ak8.js";import{s as ie}from"../chunks/BNF7Qlk4.js";import{b as _e,i as V}from"../chunks/qQMnHyvT.js";import{h as W,c as Ce,a as Se}from"../chunks/5afMHuV9.js";import{b as Ae}from"../chunks/Bj9BugY1.js";import"../chunks/DlOzM7pa.js";var Ye=y('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function Le(u){var e=Ye();l(u,e)}var Ne=y('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function Fe(u){var e=Ne();l(u,e)}var Te=y('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function Ie(u){const e=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var t=Te(),n=g(p(t),2);D(n,17,()=>e,B,(s,a)=>{let h=()=>o(a).tag,m=()=>o(a).text;var f=A(),i=_(f);K(i,h,!1,(r,c)=>{var v=ve();Y(()=>C(v,m())),l(c,v)}),l(s,f)}),d(t),l(u,t)}var Re=y("<p> </p>");function He(u,e){var t=Re(),n=p(t);d(t),Y(()=>C(n,`I am component A and my favorite number is ${e.number??""}.`)),l(u,t)}var De=y("<p> </p>");function Be(u,e){var t=De(),n=p(t);d(t),Y(()=>C(n,`I am component B and my name is ${e.name??""}.`)),l(u,t)}var Xe=y('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Me(u){const e={A:He,B:Be},t=[{component:"A",number:42},{component:"B",name:"Russell"}];var n=Xe(),s=g(p(n),2);D(s,17,()=>t,B,(a,h)=>{const m=R(()=>e[o(h).component]);var f=A(),i=_(f);Q(i,()=>o(m),(r,c)=>{c(r,$(()=>o(h)))}),l(a,f)}),d(n),l(u,n)}var Pe=y("<div><!></div>");function Ee(u,e){z(e,!0);let t=I(e,"root",3,null),n=I(e,"top",3,0),s=I(e,"bottom",3,0),a=I(e,"increments",3,100),h=I(e,"value",15,void 0),m=[],f=[],i=[],r=[],c;function v(){let b=0,w=0;for(let S=0;S<m.length;S++)m[S]>b&&(b=m[S],w=S);b>0?h(w):h(void 0)}function k(b,w){const S=M=>{M[0].isIntersecting;const Z=M[0].intersectionRatio;m[w]=Z,v()},E=n()?n()*-1:0,j=s()?s()*-1:0,ne=`${E}px 0px ${j}px 0px`,te={root:t(),rootMargin:ne,threshold:f};r[w]&&r[w].disconnect();const X=new IntersectionObserver(S,te);X.observe(b),r[w]=X}function L(){i.length&&i.forEach(k)}O(()=>{for(let b=0;b<a()+1;b++)f.push(b/a());i=c.querySelectorAll(":scope > *:not(iframe)"),L()}),O(()=>{n(),s(),L()});var x=Pe(),N=p(x);ie(N,()=>e.children??ee),d(x),_e(x,b=>c=b,()=>c),l(u,x),G()}var We=y('<div><p class="svelte-1sxgmm9"> </p></div>'),je=y('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function qe(u){let e=P(void 0);var t=je(),n=p(t),s=g(p(n)),a=p(s,!0);d(s),d(n);var h=g(n,4);Ee(h,{get value(){return o(e)},set value(m){H(e,m,!0)},children:(m,f)=>{var i=A(),r=_(i);D(r,16,()=>[0,1,2,3,4],B,(c,v,k)=>{const L=R(()=>o(e)===k);var x=We();let N;var b=p(x),w=p(b,!0);d(b),d(x),Y(()=>{N=we(x,1,"step svelte-1sxgmm9",null,N,{active:o(L)}),C(w,v)}),l(c,x)}),l(m,i)},$$slots:{default:!0}}),fe(2),d(t),Y(()=>C(a,o(e)||"-")),l(u,t)}const Oe=`{
  "ignore": [],
  "slides": [
    {
      "id": "new-slide",
    ...
    },
    {
      ...
      "body": [
        {
          "type": "text",
          "value": "The New York Public Library has an archive of over 25,000 menus, primarily from 1880-1920, including some of the first menus to resemble modern-day restaurant dining."
        }
      ]
    },
    {
      ...
      "body": [
        {
          "type": "text",
          "value": "Frank E. Buttolph (pictured above) spent decades assembling the menus as a record for future generations of the culinary and social history of her time."
        },
        {
          "type": "text",
    ...
    },
    {
      ...
      "body": [
        {
          "type": "text",
          "value": "Get enough menus together, and they can tell not just a culinary history, but a social one. I’ve searched through the archive to tell you that story in <b>ten dishes.</b> Your table is ready—right this way."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "body": [
        ...
        {
          "type": "text",
          "value": "The century is turning over, and so is the menu: dishes are mostly in English, there’s a price attached, and it’s one of a number of <i>à la carte options</i>. The menu even warns that some dishes may take 15 minutes more to prepare!"
        }
      ]
    },
    {
...
}`;var ze=y("<p></p>"),Ge=y('<details><summary></summary> <div class="content"><!></div></details>');function Ze(u,e){let t=R(()=>typeof e.content=="string"),n=R(()=>e.open==="true");var s=Ge(),a=p(s);W(a,()=>e.summary,!0),d(a);var h=g(a,2),m=p(h);{var f=r=>{var c=A(),v=_(c);W(v,()=>e.content),l(r,c)},i=r=>{var c=A(),v=_(c);D(v,17,()=>e.content,B,(k,L)=>{let x=()=>o(L).value;var N=ze();W(N,x,!0),d(N),l(k,N)}),l(r,c)};V(m,r=>{o(t)?r(f):r(i,-1)})}d(h),d(s),Y(()=>{s.open=o(n),re(s,"name",e.name)}),l(u,s)}var Je=y("<li></li>"),Ue=y("<ul></ul>");function Ve(u,e){var t=Ue();D(t,21,()=>e.li,B,(n,s)=>{var a=Je();W(a,()=>o(s),!0),d(a),l(n,a)}),d(t),l(u,t)}var Ke=y("<li></li>"),Qe=y("<ol></ol>");function $e(u,e){var t=Qe();D(t,21,()=>e.li,B,(n,s)=>{var a=Ke();W(a,()=>o(s),!0),d(a),l(n,a)}),d(t),l(u,t)}var en=y("<p></p>"),nn=y("<section><!></section>");function tn(u,e){z(e,!0);const t={details:Ze,ul:Ve,ol:$e};let n=I(e,"components",19,()=>({})),s=I(e,"body",19,()=>[]);var a=A(),h=_(a);D(h,17,s,B,(m,f)=>{let i=()=>o(f).section,r=()=>o(f).content;const c=R(()=>i().toLowerCase().replace(/[^a-z0-9]/g,"")),v=R(()=>n()[i()]);var k=nn(),L=p(k);{var x=b=>{var w=A(),S=_(w);Q(S,()=>o(v),(E,j)=>{j(E,$(r))}),l(b,w)},N=b=>{var w=A(),S=_(w);D(S,17,r,B,(E,j,ne,te)=>{let X=()=>o(j).type,M=()=>o(j).value;const Z=R(()=>n()[X()]||t[X()]),le=R(()=>typeof M()=="string");var ae=A(),ue=_(ae);{var de=F=>{var T=A(),q=_(T);Q(q,()=>o(Z),(J,U)=>{U(J,$(M))}),l(F,T)},ce=F=>{var T=en();W(T,M,!0),d(T),l(F,T)},he=F=>{var T=A(),q=_(T);K(q,X,!1,(J,U)=>{var oe=A(),pe=_(oe);W(pe,M),l(U,oe)}),l(F,T)},me=F=>{var T=A(),q=_(T);K(q,X,!1,(J,U)=>{xe(J,()=>({...M()}))}),l(F,T)};V(ue,F=>{o(Z)?F(de):X()==="text"?F(ce,1):o(le)?F(he,2):F(me,-1)})}l(E,ae)}),l(b,w)};V(L,b=>{o(v)?b(x):b(N,-1)})}d(k),Y(()=>re(k,"id",o(c))),l(m,k)}),l(u,a),G()}var an=y('<p> </p> <progress max="100"></progress>',1);function on(u,e){let t=I(e,"label",3,"A"),n=I(e,"value",3,0);var s=an(),a=_(s),h=p(a,!0);d(a);var m=g(a,2);Y(()=>{C(h,t()),ke(m,n())}),l(u,s)}var sn=y('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function rn(u,e){z(e,!0);const{body:t}=Ce,n={Test:on};var s=sn(),a=g(p(s),2),h=p(a),m=p(h,!0);d(h),d(a);var f=g(a,2);tn(f,{get components(){return n},get body(){return t}}),d(s),Y(i=>C(m,i),[()=>Oe.replace(/\t/g," ")]),l(u,s),G()}const ln=(u,e=ee)=>{var t=un(),n=p(t),s=p(n,!0);d(n);var a=g(n,2),h=p(a,!0);d(a),d(t),Y(()=>{C(s,e().name),C(h,e().age)}),l(u,t)};var un=y('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),dn=y('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function cn(u,e){z(e,!0),I(e,"age",3,30);const t=[{name:"John",age:30},{name:"Jill",age:45}];let n=P(0),s=R(()=>o(n)*2),a=R(()=>o(n)*2),h=P(0);O(()=>{H(h,o(n)*2)});var m=dn(),f=g(_(m),4),i=g(f,2),r=p(i);d(i);var c=g(i,2),v=p(c);d(c);var k=g(c,2),L=p(k);d(k);var x=g(k,4),N=p(x);ie(N,()=>e.children??ee),d(x);var b=g(x,4),w=g(b,4);D(w,21,()=>t,B,(S,E)=>{ln(S,()=>o(E))}),d(w),Y(()=>{C(r,`${o(n)??""} doubled is ${o(s)??""} (derived)`),C(v,`${o(n)??""} doubled is ${o(a)??""} (derived by)`),C(L,`${o(n)??""} doubled is ${o(h)??""} ($effect)`)}),se("click",f,()=>ge(n)),se("click",b,()=>e.random(Math.floor(Math.random()*10))),l(u,m),G()}be(["click"]);const hn=(u,e)=>{let t=P(ye(u)),n=P(null),s=P(!0),a=P(void 0);const h=(i=!0)=>{H(s,i,!0),i===!0&&(H(a,null),H(n,null))},m=async()=>{try{const i=await fetch(o(t),e);if(!i.ok)throw new Error(`Unexpected error occurred (status ${i.status})`);let r;if(o(t).includes(".csv")){const c=await i.text();r=Se(c)}else r=await i.json();return[null,r]}catch(i){const{errorMessage:r="Unexpected error eccurred"}=i;return[r,null]}},f=async i=>{h(!0);const[r,c]=await m();if(i===o(t)){if(r){h(!1),H(a,r,!0);return}h(!1),H(n,c,!0)}};return O(()=>{f(o(t))}),{get data(){return o(n)},get loading(){return o(s)},get error(){return o(a)},get url(){return o(t)},set url(i){o(t)!==i&&H(t,i,!0)}}};var mn=y("<p>loading data...</p>"),pn=y("<p> </p>"),fn=y("<p>data loaded</p> <pre> </pre>",1),gn=y('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function yn(u,e){z(e,!0);const t=`${Ae}/assets/demo/test.csv`,n=hn(t);O(()=>{});var s=gn(),a=g(p(s),2),h=p(a);{var m=r=>{var c=mn();l(r,c)},f=r=>{var c=pn(),v=p(c);d(c),Y(()=>C(v,`error: ${n.error??""}`)),l(r,c)},i=r=>{var c=fn(),v=g(_(c),2),k=p(v,!0);d(v),Y(L=>C(k,L),[()=>JSON.stringify(n.data,null,2)]),l(r,c)};V(h,r=>{n.loading?r(m):n.error?r(f,1):r(i,-1)})}d(a),d(s),l(u,s),G()}var vn=y('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function bn(u){let e=P(0);function t(v){console.log(v)}var n=vn(),s=g(p(n),2);Le(s);var a=g(s,2);Fe(a);var h=g(a,2);Ie(h);var m=g(h,2);Me(m);var f=g(m,2);rn(f,{});var i=g(f,2);yn(i,{});var r=g(i,2);qe(r);var c=g(r,2);cn(c,{random:t,get value(){return o(e)},set value(v){H(e,v,!0)}}),d(n),l(u,n)}function Rn(u){bn(u)}export{Rn as component};
